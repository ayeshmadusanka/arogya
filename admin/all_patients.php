                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <h4 class="card-title">All Patients</h4>
                                <h6 class="card-subtitle">List of all Patients</h6>
...
<tbody>
    <?php
        ...
        if (!mysqli_num_rows($query) > 0) {
            echo '<td colspan="10"><center>No Patients Data Found </center></td>';
        } else {
            while ($rows = mysqli_fetch_array($query)) {
                ...
                echo '<tr>
                    ...
                    <td>' . $rows['p_id'] . '</td>
                    <td>' . $rows['p_name'] . '</td>
                    <td>' . $rows['p_contact'] . '</td>
                    <td>' . $rows['p_address'] . '</td>
                    <td>' . $rows['p_gender'] . '</td>
                    <td>' . $rows['p_dob'] . '</td>
                    <td>' . $rows['p_creation_dt'] . '</td>
                    <td>' . $rows['p_updated_dt'] . '</td>
                    <td>
                    <a href="edit_patient.php?p_id=' . $rows['p_id'] . '" class="btn btn-info btn-sm">Edit</a>
                    <a href="#" onclick="confirmDelete(' . $rows['p_id'] . ')" class="btn btn-danger btn-sm">Delete</a>
                    <a href="patient_appointments.php?p_id=' . $rows['p_id'] . '" class="btn btn-primary btn-sm">Appointments</a>    
                    <a href="patient_treatment_history.php?p_id=' . $rows['p_id'] . '" class="btn btn-success btn-sm">Treatment History</a>               
...
function confirmDelete(patientId) {
    ...
    if (confirmDelete) {
        // If the user confirms, redirect to the delete_patient.php page
        window.location.href = 'delete_patient.php?p_id=' + patientId;
    }
