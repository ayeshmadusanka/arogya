...
<?php
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                echo '<td colspan="11"><center>No Doctors Data Found </center></td>';
                                            } else {
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo '<tr>
                                                        <td>' . $rows['d_id'] . '</td>
                                                        <td>' . $rows['d_name'] . '</td>
                                                        <td>' . $rows['d_contact'] . '</td>
                                                        <td>' . $rows['d_address'] . '</td>
                                                        <td>' . $rows['d_gender'] . '</td>
                                                        <td>' . $rows['d_dob'] . '</td>
                                                        <td>' . $rows['d_type'] . '</td>
                                                        <td>' . $rows['d_fees'] . '</td>
                                                        <td>' . $rows['d_creation_dt'] . '</td>
                                                        <td>' . $rows['d_updated_dt'] . '</td>
                                                        <td>
                                                            <a href="edit_doctor.php?d_id=' . $rows['d_id'] . '" class="btn btn-info btn-sm">Edit</a>
                                                            <a href="delete_doctor.php?d_id=' . $rows['d_id'] . '" class="btn btn-danger btn-sm">Delete</a>
                                                            <a href="schedule.php?d_id=' . $rows['d_id'] . '" class="btn btn-success btn-sm">Schedule</a>
                                                            <a href="doctor_treatment_history.php?d_id=' . $rows['d_id'] . '" class="btn btn-primary btn-sm">Treatment History</a>
